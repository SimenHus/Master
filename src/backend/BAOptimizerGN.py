...
from gtsam import LevenbergMarquardtOptimizer, Marginals, GaussNewtonOptimizer
...
class BAOptimizerGN:
    ...
    def optimize(self) -> Values:
        ...
        self.result = GaussNewtonOptimizer(self.factors_master, self.nodes_master).optimize()
        return self.result
